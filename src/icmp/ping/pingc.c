...
int main(int argc, char * argv[]){
  ...
  struct icmphdr *icmph = (struct icmphdr *)(sendbuf + iphdrlen);
  sendbuf[iphdrlen+sizeof(icmph)+4]='H';
  sendbuf[iphdrlen+sizeof(icmph)+5]='O';
  sendbuf[iphdrlen+sizeof(icmph)+6]='L';
  sendbuf[iphdrlen+sizeof(icmph)+7]='A';
  sendbuf[iphdrlen+sizeof(icmph)+8]='M';
  sendbuf[iphdrlen+sizeof(icmph)+9]='U';
  sendbuf[iphdrlen+sizeof(icmph)+10]='N';
  sendbuf[iphdrlen+sizeof(icmph)+11]='D';
  sendbuf[iphdrlen+sizeof(icmph)+12]='O';
